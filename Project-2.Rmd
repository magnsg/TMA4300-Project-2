...
\propto
p(\boldsymbol{y}, \boldsymbol{\tau} | \sigma^2) \cdot p(\sigma^2) \\

=
p(\boldsymbol{y} | \boldsymbol{\tau}, \sigma^2) \cdot p(\boldsymbol{\tau} | \textbf{y}, \sigma^2) \cdot p(\sigma^2) \\
...
\text{for shape $\alpha$ and rate $\beta$.}
$$
